...
from bot.helper.ext_utils.bot_utils import get_readable_file_size, is_gdrive_link, is_gdtot_link, new_thread, get_readable_time
    ...
    if is_gdrive_link(link):
        ...
        if files <= 20:
            ...
            try:
                ...
                pass
        cc = f"\n\n<b>Elapsed:</b> {get_readable_time(time() - get_time)}"
        cc += f'\n<b>User: </b>{tag}'
